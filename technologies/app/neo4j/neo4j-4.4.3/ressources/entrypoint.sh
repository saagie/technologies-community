...
echo "
- 'NEO4J_PASSWORD' variable is optional and set the default password for Neo4j admin user
If this variable is not set, the default user / password is 'neo4j / test'
The Neo4j admin user name cannot be changed, it must be 'neo4j'
"

# Neo4j admin user name cannot be changed and must be 'neo4j'
NEO4J_LOGIN="neo4j"
