...
echo "
- 'SHINY_GIT_URL_REPOSITORY' variable is mandatory and should be set to the name of the git repository continning your RShiny app source code (e.g.:https://github.com/saagie/demo-r-shiny.git).
